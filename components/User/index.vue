...
<template>
  <div relative overflow-hidden rounded-md p2 flex="~ items-center" border="~ dark:gray-600/80 hover:primary">
    ...
    <div min-w-0 space-y-1>
      ...
      <div flex gap-3>
        ...
        <IconText icon-name="ic:outline-update" title="最近更新" :text="dayjs(user.updated_at).fromNow() " text-green-500 />
      </div>
