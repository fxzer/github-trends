import{_ as P}from"./Crf_9S2Q.js";import{_ as S}from"./DlzlXt5A.js";import E from"./Ca4V3wQy.js";import{_ as q}from"./DiQHfW2O.js";import{_ as B}from"./B5OdjIU1.js";import{_ as W}from"./AV2fIV32.js";import{s as D,u as H,a as M,b as j,c as Y}from"./B1ndPO42.js";import{n as L,q as F,h as C,o as m,c as b,s as G,r as _,v as K,x as A,B as J,b as c,w as k,C as z,D as R,y as s,T as Q,a as X,E as V,z as $,A as x}from"./BQg_0o72.js";import Z from"./_kkk_dU2.js";import{f as ee}from"./C9QiLSHs.js";import"./QcV1Qulz.js";import"./p2-M2djV.js";import"./DZKlCKD5.js";import"./B_3-rVtm.js";import"./1WCNvjev.js";const ae=L({__name:"Chart",setup(N){const a=F("data"),r=[{name:"stars",color:"rgb(159 ,224 ,128"},{name:"forks",color:"rgb(249 ,200 ,88"}].map(D),u=H("仓库人气榜",r),{domRef:l}=M(u,j);function p(n){const[d,h,g]=n.reduce((e,t)=>(e[0].unshift(t.stars),e[1].unshift(t.forks),e[2].unshift(t.full_name),e),[[],[],[],[]]);u.value.yAxis.data=g,u.value.series[0].data=d,u.value.series[1].data=h}C(a,()=>{p(a.value)},{deep:!0,immediate:!0});const y=`${100+a.value.length*40}px`;return(n,d)=>(m(),b("div",{ref_key:"chartRef",ref:l,style:G({height:y})},null,4))}}),te={"flex-center":"",class:"h-[calc(100vh-150px)]"},ve=L({__name:"repo",setup(N){const{view:a,language:r,color:u}=Y(),l=_([]),p=_({endCursor:"",hasNextPage:!1}),y=K(()=>`query {
